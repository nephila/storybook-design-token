...
function parseSvgFiles(files) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            categoryNames = tokens.map(function (token) { return token.categoryName; }).filter(function (v, i, a) { return a.indexOf(v) === i; });
            return [2 /*return*/, categoryNames.map(function (name) {
                    return {
                        name: name || "SVG Icons",
    ...
    return files
        ...
        return svgs
            ...
            description: (svg === null || svg === void 0 ? void 0 : svg.getAttribute('data-token-description')) ||
                '',
            categoryName: (svg === null || svg === void 0 ? void 0 : svg.getAttribute('data-token-category')) ||
                'SVG Icons',
            presenter: token_types_1.TokenPresenter.SVG,
